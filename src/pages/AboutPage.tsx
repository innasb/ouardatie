const translations = {
  en: {
    hero: {
      ...
      subtitle: 'My Flowers · Comfortably Beautiful ✨',
    },
    story: {
      title: 'Our Story',
      p1: 'Like flowers blooming in an Algerian garden, OUARDATIE emerged from a simple yet profound vision — to create clothing that makes women feel naturally beautiful and genuinely comfortable.',
      p2: 'Our name, meaning "my flowers" in Arabic, captures the essence of what we do. Just as each flower has its unique beauty, each woman deserves pieces that celebrate her individuality while embracing her in comfort.',
      p3: 'From the vibrant streets of Algeria to your wardrobe, every OUARDATIE piece carries the warmth of our heritage and the freshness of modern design. We blend traditional elegance with contemporary comfort, creating a garden of styles where every woman can find her bloom.',
  ...
  fr: {
    hero: {
      ...
      subtitle: 'Mes Fleurs · Confortablement Belle ✨',
    },
    story: {
      title: 'Notre Histoire',
      p1: "Comme des fleurs s'épanouissant dans un jardin algérien, OUARDATIE est née d'une vision simple mais profonde — créer des vêtements qui font que les femmes se sentent naturellement belles et véritablement à l'aise.",
      p2: 'Notre nom, qui signifie "mes fleurs" en arabe, capture l\'essence de ce que nous faisons. Tout comme chaque fleur a sa beauté unique, chaque femme mérite des pièces qui célèbrent son individualité tout en l\'enveloppant de confort.',
      p3: "Des rues vibrantes d'Algérie à votre garde-robe, chaque pièce OUARDATIE porte la chaleur de notre patrimoine et la fraîcheur du design moderne. Nous mélangeons l'élégance traditionnelle avec le confort contemporain, créant un jardin de styles où chaque femme peut trouver sa floraison.",
  ...
  ar: {
    hero: {
      title: 'عن ورداتي',
      subtitle: 'ورداتي · جمال براحة ✨',
    },
    story: {
      title: 'قصتنا',
      p1: 'مثل الورود المتفتحة في حديقة جزائرية، ولدت ورداتي من رؤية بسيطة لكن عميقة — إنشاء ملابس تجعل المرأة تشعر بالجمال الطبيعي والراحة الحقيقية.',
      p2: 'اسمنا، "ورداتي" بالعربية، يعكس جوهر ما نقوم به. فكما أن لكل وردة جمالها الفريد، تستحق كل امرأة قطعاً تحتفي بفرادتها وتحتضنها بالراحة.',
      p3: 'من شوارع الجزائر النابضة بالحياة إلى خزانة ملابسك، تحمل كل قطعة من ورداتي دفء تراثنا ونضارة التصميم العصري. نمزج الأناقة التقليدية مع الراحة المعاصرة، لنصنع حديقة من الأساليب حيث يمكن لكل امرأة أن تجد إطلالتها المميزة.',
      imageAlt: 'صورة القصة',
    },
    philosophy: {
      title: 'فلسفتنا',
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="aspect-[4/5] bg-gradient-to-br from-[#E8E3DC] to-[#F5F1EB] rounded-sm flex items-center justify-center">
              <div className="text-gray-400 text-center p-8">
                ...
                <p className="text-sm">{t.story.imageAlt}</p>
              </div>
            </div>
          </div>
        </div>
